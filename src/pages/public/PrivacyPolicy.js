  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 py-16 text-center">
        <h1 className="font-serif text-4xl text-zinc-900 mb-6">Privacy Policy</h1>

        <div className="space-y-4 text-sm text-zinc-600 leading-relaxed mb-10">
          <p>
            At www.wine2u.com, accessible from www.wine2u.com, one of our main priorities is the privacy of our
            visitors. This Privacy Policy document contains types of information that is collected and recorded by
            www.wine2u.com and how we use it.
          </p>
          <p>
          ...
          <p>
            ...
            regards to the information that they shared and/or collect in www.wine2u.com. This policy is not
        ...
        <Section title="Log Files">
          <p>
            www.wine2u.com follows a standard procedure of using log files. These files log visitors when they
        ...
        <Section title="Cookies and Web Beacons">
          <p>
            Like any other website, www.wine2u.com uses 'cookies'. These cookies are used to store information
          ...
          <p>
            For more general information on cookies, please read <span className="font-semibold text-zinc-900">more on the Cookie Consent website</span>.
          </p>
        </Section>

        <Section title="Advertising Partners Privacy Policies">
          <p>You may consult this list to find the Privacy Policy for each of the advertising partners of www.wine2u.com.</p>
          <p>
            Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
            are used in their respective advertisements and links that appear on www.wine2u.com, which are sent
          ...
          <p>Note that www.wine2u.com has no access to or control over these cookies that are used by third-party advertisers.</p>
        </Section>

        <Section title="Third Party Privacy Policies">
          <p>
            www.wine2u.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
        ...
        <Section title="Children's Information">
          ...
          <p>
            www.wine2u.com does not knowingly collect any Personal Identifiable Information from children under the
