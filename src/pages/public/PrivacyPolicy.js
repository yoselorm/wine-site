...
const PrivacyPolicy = () => {
  return (
    <div className="bg-cream min-h-screen">
      <SectionBanner title="Privacy Policy" breadcrumbs={[{ label: 'Home', to: '/' }, { label: 'Privacy Policy' }]} />

      <div className="max-w-3xl mx-auto px-6 py-16">
        <div className="space-y-4 text-base text-zinc-600 font-light leading-relaxed mb-10">
          <p>
            At wine2u.com, accessible from wine2u.com, one of our main priorities is the privacy of our visitors.
            This Privacy Policy document contains types of information that is collected and recorded by wine2u.com
            and how we use it.
          </p>
          <p>
          ...
          <p>
            ...
            regards to the information that they shared and/or collect in wine2u.com. This policy is not applicable
        ...
        <Section title="Log Files">
          <p>
            wine2u.com follows a standard procedure of using log files. These files log visitors when they visit
            ...
            not linked to any information that is personally identifiable. The purpose of the information is for
        ...
        <Section title="Cookies and Web Beacons">
          <p>
            Like any other website, wine2u.com uses 'cookies'. These cookies are used to store information
        ...
        <Section title="Advertising Partners Privacy Policies">
          <p>You may consult this list to find the Privacy Policy for each of the advertising partners of wine2u.com.</p>
          <p>
            Third-party ad servers or networks use technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on wine2u.com, which are sent directly to
            users' browsers. They automatically receive your IP address when this occurs. These technologies are
            used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising
            content that you see on websites that you visit.
          </p>
          <p>Note that wine2u.com has no access to or control over these cookies that are used by third-party advertisers.</p>
        </Section>

        <Section title="Third Party Privacy Policies">
          <p>
            wine2u.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
          ...
          <p>
            You can choose to disable cookies through your individual browser options. To learn more detailed
        ...
        <Section title="Children's Information">
          <p>
            ...
            parents and guardians to observe, participate in, and/or monitor and guide their children's online
            activity.
          </p>
          <p>
            wine2u.com does not knowingly collect any Personal Identifiable Information from children under the age
